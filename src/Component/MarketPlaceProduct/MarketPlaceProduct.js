...
const MarketPlaceProduct = () => {
    return (
        <div className='marketPlaceContainer grid lg:grid-cols-6 lg:gap-x-10 lg:gap-y-7 sm:grid-cols-3 sm:gap-x-5 sm:gap-y-3 md:grid-cols-4 md:gap-x-5 gap-y-3 m-5    '>
